...
Proyecto: Demo. Modo: preliminar. Fecha: 2026-09-17 13:34.
...
Versión: MTC-LL-2.2. Modo: preliminar.
SHA256 entrada: `c4a31e6ae2915b6e907563e488683c9c61dba487ee961751b0a5ae00ed96e572`.
SHA256 código: `4233762536e179027af6675555f85c64d7c6889b380f22be1e3e6eab7627ded2`.
SOLO SOCAVACIÓN LOCAL por Froehlich en estribos. Socavación general, contracción y largo plazo NO EVALUADOS, no son cero. No determina socavación total, cota del lecho final ni profundidad de cimentación.
...
Dato hidraulica: EX-F: ejemplo sintético de software; NO resultado de un modelo HEC-RAS real  
Dato geometria: EX-F: ejemplo sintético de software; NO resultado de un modelo HEC-RAS real  
Dato local: EX-F: ejemplo sintético de software; NO resultado de un modelo HEC-RAS real  
...
```json
{
  ...
  "fuentes": {
    "hidrologia": "EX-F: ejemplo sintético de software; NO resultado de un modelo HEC-RAS real"
  },
  ...
  "estribo_izquierdo": {
    ...
    "q100": {
      ...
      "L_obstruida": 2.0,
      "fuentes": {
        "hidraulica": "EX-F: ejemplo sintético de software; NO resultado de un modelo HEC-RAS real",
        "geometria": "EX-F: ejemplo sintético de software; NO resultado de un modelo HEC-RAS real",
        "local": "EX-F: ejemplo sintético de software; NO resultado de un modelo HEC-RAS real"
      }
    },
    "q500": {
